...
// A custom Cart context (ensure src/contexts/CartProvider.js exists)
import { useCart } from "../../contexts/CartProvider"

import Navbar from "../components/Shared/NavBar"       // Ensure this path is correct
import * as styles from "./styles/foodDelivery.module.css" // or adjust if your CSS is elsewhere
    ...
    const fetchRestaurants = async () => {
      try {
        ...
        const fetchedRestaurants = querySnapshot.docs.map((doc) => {
          ...
          return {
            ...data,
            // Convert menu if it's an object or array
            menu: Array.isArray(data.menu)
              ? data.menu
              : Object.entries(data.menu || {}).flat(),
          }
        })
